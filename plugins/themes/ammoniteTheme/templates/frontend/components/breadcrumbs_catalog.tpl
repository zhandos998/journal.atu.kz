{**
 * @file plugins/themes/ammoniteTheme/templates/frontend/components/breadcrumbs_catalog.tpl
 *
...
<div class="row pt-4 mt-1">
	<nav role="navigation" aria-label="{translate key="navigation.breadcrumbLabel"}">
		<ol class="breadcrumb align-items-start">
			<li class="breadcrumb-item">
				<a class="ammonite-breadcrumb-text text-decoration-none"
			...
			{if $parent}
				<li class="breadcrumb-item">
					<a class="ammonite-breadcrumb-text text-decoration-none" href="{url op=$type path=$parent->getPath()}">
